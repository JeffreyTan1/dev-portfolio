...
export default function Contact({userID, serviceID, templateID}: Props): ReactElement {
      ...
      >
        <h2><span>{`04. `}</span>Contact Me</h2>
        {
          ...
          <form ref={form} onSubmit={sendEmail}>
            ...
            <motion.button variants={item} type="submit" className={styles.sendBtn}><FiSend style={{position: 'relative', top: '0.rem'}}/></motion.button>
            {
